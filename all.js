...
var isSequenceable = function(x) { return typeof x == "string" || isArray(x) }
...
ReadStream.prototype.next  = function() { return get(this.src, this.pos++) }
...
OMInputStream.prototype.type = function() { return typeof this.lst }
...
var get = 'x'[0] === 'x' ?
	function(a, idx) { return a[idx] } :
	function(a, idx) { return typeof a === 'string' ? a.charAt(idx) : a[idx] }
...
var OMeta = {
  ...
  seq: function(xs) {
    for (var idx = 0; idx < xs.length; idx++)
      this._applyWithArgs("exactly", get(xs, idx))
    return xs
  },
...
"semAction":function(){var $elf=this,_fromIdx=this.input.idx,r;return this._or((function(){return this._apply("curlySemAction")}),(function(){return (function(){r=this._apply("primExpr");this._apply("spaces");return r}).call(this)}))}});
...
"Grammar":function(){var $elf=this,_fromIdx=this.input.idx,name,sName,rules;return (function(){name=this._apply("anything");sName=this._apply("anything");(this["name"]=name);(this["sName"]=sName);rules=this._many((function(){return this._apply("trans")}));return ["var ",name,"=objectThatDelegatesTo(",sName,",{",rules.join(","),"})"].join("")}).call(this)},
...
"Rule":function(){var $elf=this,_fromIdx=this.input.idx,name,ls,body;return (function(){name=this._apply("anything");ls=this._apply("anything");body=this._apply("trans");return ["Rule",name,ls,body]}).call(this)}});(BSNullOptimization["initialize"]=(function (){(this["_didSomething"]=false)}));
...
"jtChoices":function(){var $elf=this,_fromIdx=this.input.idx,op,c,jt;return (function(){op=this._apply("anything");c=this._apply("jtChoice");jt=new JumpTable(op,c);this._many((function(){return (function(){c=this._apply("jtChoice");return jt.add(c)}).call(this)}));this._apply("setHelped");return jt.toTree()}).call(this)}});
...
var alert = typeof window !== 'undefined' && window && window.alert ? window.alert : function (s) { console.log(s) }
